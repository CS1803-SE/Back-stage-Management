			...
			<script>
                layui.use(['laypage', 'layer'], function() {
					...
					table.render({
                        elem: '#demo'
                        ,height: 800
                        ,url: '../../application/museumData/museum_treasure.php'//数据接口
                    ...
                    ,limit:15
                        ...
                        ,cols: [[ //表头
                                  {field: 'collectionID', title: '藏品编号', width:80, sort: true, fixed: 'left'}
                                  ,{field: 'museumID', title: '博物编号', width:80,  fixed: 'left'}
                                  ,{field: 'collectionIntroduction', title: '藏品介绍', width: 300}
                                  ,{field: 'collectionName', title: '藏品名字', width: 200, totalRow: true}
                                  ,{field: 'museumName', title: '博物馆名字', width:200}
                                  ,{field: 'collectionImageLink', title: '藏品链接', width: 150,templet:
                                          '<div><a href="{{d.collectionImageLink}}" class="layui-table-link" target="_blank">{{d.collectionImageLink}}</a></div>'}
                    ...
                    table.on('tool(test)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
                        ...
                        function deluser(data,index,obj){
                            $.ajax({
                                url: '../../application/museumData/museum_treasure_delete.php',    //这个是后台的路由地址
                                type: "POST",
                        ...
                        function showEdit(datas) {
                            ...
                            layer.open({
                                ...
                                yes: function (layIndex) {
                                    $.ajax({
                                        url: '../../application/museumData/collection_edit.php',    //这个是后台的路由地址
                                        type: "POST",
